...
def cd_diagram(result, reverse, ax, width):
    ...
    # =========================
    LW_RANK_AXIS = 1.5      # middle horizontal rank line
    LW_TICKS = 1.0          # tick marks on rank axis
    LW_CONNECTORS = 2.0     # vertical + horizontal connector lines


    LW_NO_SIG = 3.0         # statistical similarity (no-significance) bars

    LW_CD = LW_RANK_AXIS             # CD bar
    LW_CD_TICKS = LW_TICKS       # CD bar end ticks
    ...
    # =========================
    # Rank axis (middle line)
    # =========================
    plot_line([(textspace, cline), (width - textspace, cline)],
              linewidth=LW_RANK_AXIS)
    ...
    plot_line([(begin, distanceh), (end, distanceh)],
              linewidth=LW_CD)
    plot_line([(begin, distanceh + bigtick / 2),
               (begin, distanceh - bigtick / 2)],
              linewidth=LW_CD_TICKS)
